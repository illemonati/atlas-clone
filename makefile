...
%.o: %.cpp
	$(CXX) -O3 -c -I. -IBAM -Ibamtools -Icommonutilities -IGenomeTasks -IGenotypeLikelihoods -IGLF -IPopulationTools -ISimulations -ITests -IVCF $(OBJFLAG)  $< -o $@
