...
//TAlignmentMerger
TAlignmentMerger::TAlignmentMerger(BamWriter* Writer, TAlignmentParser* Parser, int MaxDistanceBetweenMates){
	writer = Writer;
	parser = Parser;
...
TAlignmentMergerEntry::TAlignmentMergerEntry(TAlignment &Alignment, bool readyForWriting){
    alignment = new TAlignment(Alignment);
    ready = readyForWriting;
}

TAlignmentMergerEntry::TAlignmentMergerEntry(TAlignmentMergerEntry &&other):alignment(nullptr),ready(false){
    //copy from other
