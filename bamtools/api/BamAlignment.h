...
struct API_EXPORT BamAlignment {
    ...
    public:        
        ...
        bool IsSupplementary(void) const;     // returns true if alignment is supplementary
    ...
    public:
        ...
        int32_t		NumInsertions;		// number of insertions, given by CIGAR
        ...
        //Mod by Vivian Link: added NumInsertions
