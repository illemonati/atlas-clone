...
recal="intercept[0.1];quality:polynomial[0.9,0.01]"
pmd="CT5:0.1*exp(-0.2*p)+0.001;GA3:0.1*exp(-0.2*p)+0.001"

. $(dirname $0)/simulate --chrLength 102109,103210 --ploidy 2,1 --depth 11,8 --recal $recal --pmd $pmd --baseQuality "categorical(12,22,27,32,37,41)"
