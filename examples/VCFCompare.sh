...
. $(dirname $0)/simulate --vcf --type HW --sampleSize 2 --chrLength 2000 --ploidy 2 --out simulate1 --logFile simulate1.out --fixedSeed 1
. $(dirname $0)/simulate --vcf --type HW --sampleSize 2 --chrLength 2000 --ploidy 2 --out simulate2 --logFile simulate2.out --fixedSeed 2
