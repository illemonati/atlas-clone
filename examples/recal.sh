...
$atlas --task recal --bam ATLAS_simulations.bam --recal "intercept;quality:polynomial3" --minDeltaLL 1e6 --fixedSeed 0 --out polynomial --logFile polynomial.out
...
$atlas --task recal --bam ATLAS_simulations.bam --recal "intercept;quality;position;context;fragmentLength;mappingQuality;" --minDeltaLL 1e6 --fixedSeed 0 --out empiric --logFile empiric.out
