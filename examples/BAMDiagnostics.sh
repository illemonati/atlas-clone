...
u=$(echo "$i*5" | bc)
$atlas --task BAMDiagnostics --bam ATLAS_simulations_ind"$i".bam --filterSoftClips --fixedSeed 0 --filterMQ 0,$u --blacklist blacklist_"$i".txt --filterReadLength 0,$u --filterFragmentLength 0,$u
done
