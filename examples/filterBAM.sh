...
u=$(echo "$i*5" | bc)
$atlas --task filterBAM --bam ATLAS_simulations_ind$i.bam --fixedSeed 0 --filterMQ 0,$u --blacklist blacklist_$i.txt --filterReadLength 0,$u --filterFragmentLength 0,$u --logFile filterBAM_$i.out
done
