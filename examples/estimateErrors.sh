...
$atlas --task estimateErrors --bam ATLAS_simulations.bam --fasta ATLAS_simulations.fasta --recalModel "intercept;quality" --minDeltaLL 1e-4 --fixedSeed 0 --out onlyQual --logFile onlyQual.out --noRho --noPsi
