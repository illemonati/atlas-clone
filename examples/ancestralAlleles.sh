...
$atlas --task ancestralAlleles --alleleCounts ATLAS_simulations_alleleCounts.txt.gz --minorCountMaximum 2 --totalCountMinimum 4 --logFile ancestralAlleles.out --fixedSeed 0
