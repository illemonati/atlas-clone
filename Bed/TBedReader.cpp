...
void TBedReaderChromosome::addPosition(std::vector<std::string> &tmp){
...
//TBedReader
void TBedReader::readFile(SamSequenceDictionary &Sequences, TLog *logfile){
    //open file
...
TBedReader::TBedReader(std::string Filename, int &WindowSize, SamSequenceDictionary &Sequences, TLog *logfile){
    filename = Filename;
    windowSize = WindowSize;
