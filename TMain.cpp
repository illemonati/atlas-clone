...
TMain::TMain(std::string ApplicationName, std::string Version, std::string Web){
...
int TMain::run(int argc, char *argv[]){
    bool hadErrors = false;
    try{
        //read parameters from the command line
        TParameters parameters(argc, argv, &logfile);

        //Set Tool to use for Input/Output
        IOTool::setParameter(parameters.getParameterStringWithDefault("tool","bamtools"));
